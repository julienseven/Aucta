...
| M5 — Transaction loop | Implemented locally. Idempotent SQL settlement plus mock pay, manual ship, receipt and review mutations. Payouts stay pending. Real providers, refunds and disputes are not connected. |
...
The next feature milestone is M6 polish. M2 hosted scheduler and real PostgreSQL concurrency remain acceptance gates. Seeded completed orders do not replace the SQL and browser mutation tests.
