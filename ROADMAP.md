...
The next feature milestone is M6 polish. M2 closer/concurrency remains an acceptance gate. Seeded completed orders do not replace the SQL mutation tests.
